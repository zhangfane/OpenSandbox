...
T = TypeVar("T", bound="IsolatedReplaceContentResponse200")


@_attrs_define
class IsolatedReplaceContentResponse200:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        isolated_replace_content_response_200 = cls()
        ...
        isolated_replace_content_response_200.additional_properties = additional_properties
        return isolated_replace_content_response_200
