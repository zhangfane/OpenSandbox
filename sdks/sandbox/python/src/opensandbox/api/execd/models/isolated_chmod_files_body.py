...
T = TypeVar("T", bound="IsolatedChmodFilesBody")


@_attrs_define
class IsolatedChmodFilesBody:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        isolated_chmod_files_body.additional_properties = additional_properties
        return isolated_chmod_files_body
