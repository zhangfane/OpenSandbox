...
T = TypeVar("T", bound="IsolatedMakeDirsBody")


@_attrs_define
class IsolatedMakeDirsBody:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        isolated_make_dirs_body.additional_properties = additional_properties
        return isolated_make_dirs_body
